...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<
      ...
      true
    >;
    mcp_servers: Schema.Attribute.Relation<
      'manyToMany',
      'api::mcp-server.mcp-server'
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Captured email leads from the global login + demos. Written by colaberry.ai /auth/verify on every sign-in; the email is the #1 goal.';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Enterprise departments that own agent groups';
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    seo: Schema.Attribute.Component<'shared.seo', false>;
    skillCollections: Schema.Attribute.Relation<
      'manyToMany',
      'api::skill-collection.skill-collection'
    >;
